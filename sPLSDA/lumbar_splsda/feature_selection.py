...
from lumbar_splsda.feature_selection_legacy import (
    SEGMENTS,
...
class FeatureSelectionDataset:
    ...
    def feature_names(self) -> list[str]:
        return list(self.X_split.columns)

    @property
    def classic_feature_names(self) -> list[str]:
        return [str(c) for c in self.X_split.columns if str(c).startswith("classic_")]
