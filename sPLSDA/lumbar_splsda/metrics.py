...
def compute_ordinal_metrics(
    *, y_true: np.ndarray, y_pred: np.ndarray, y_cont: np.ndarray, n_classes: int | None = None
    ...
    """
    Compute a shared set of ordinal + continuous metrics aligned with ProtoNAM:
    - Discrete ordinal prediction quality: MAE, QWK, Acc±1, Acc, BAcc, Macro/Weighted-F1
    - Continuous severity alignment: Spearman, CCC
    """
