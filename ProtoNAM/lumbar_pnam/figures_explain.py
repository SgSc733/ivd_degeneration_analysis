...
from lumbar_pnam.figures_explain_cases import save_case_contribution_plots
from lumbar_pnam.figures_explain_collect import collect_fold_contributions
from lumbar_pnam.figures_explain_importance import compute_feature_importance, save_feature_importance_overview
from lumbar_pnam.figures_explain_stability import save_explain_stability_plots
...
def generate_explain_figures(
    *,
    ...
    return {
        ...
        "n_features": int(len({feat for fd in folds for feat in fd.feature_names})),
