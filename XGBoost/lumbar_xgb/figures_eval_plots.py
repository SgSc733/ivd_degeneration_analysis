...
"""Post-training evaluation figures (shared with ProtoNAM figure style).

Key principle (per 方案1.md + 主方案图示口径):
- Any discrete-grade figure should be based on the *calibrated* decoded grade.
"""
...
def _t_crit_975(df: int) -> float:
    try:
        ...
        # Keep the plot working even without scipy.
        return 2.0
